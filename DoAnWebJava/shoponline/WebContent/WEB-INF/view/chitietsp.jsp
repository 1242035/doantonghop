    ...
    <c:forEach var="sp" items="${dssp}">
    	<div class="prod_box">
            ...
            <div class="center_prod_box">            
                 <div class="product_title"><a href="details.html">${sp.tensp }</a></div>
                 <div class="product_img"><a href="details.html"><img src="upload/${sp.hinhanh }" alt="" title="" border="0" height='92' width='97'/></a></div>
